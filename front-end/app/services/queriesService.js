...
app.factory('queriesService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _getQueriesId = function (id) {
        $http.defaults.headers.common["X-Custom-Header"] = "Angular.js";
        return $http.get(serviceBase + 'api/Matrix/repository/AssuntoQuery/' + id).then(function (results) {
    ...
    var _postQueries = function (Data, callback) {
        $http.post(serviceBase + 'api/Matrix/repository/AssuntoQuery/save/new', Data).success(function (response) {
    ...
    var _updateQueries = function (Data, callback) {
        $http.post(serviceBase + 'api/Matrix/repository/AssuntoQuery/save/update', Data).success(function (response) {
            callback(response, null);
        }).error(function (err, status) {
            callback(err, status);
    ...
    queriesServiceFactory.updateQueries = _updateQueries;

    

    queriesServiceFactory.getQueries = _getQueries;
    queriesServiceFactory.getQueriesId = _getQueriesId;
