...
app.service('LoadTreeService', ["$resource", function ($resource) {
    return $resource('server/editor/filetree.json');
}]);
app.config(['$routeProvider', 'RouteHelpersProvider', function ($routeProvider, helper) {
    ...
    $routeProvider.when("/home", {
        ...
        templateUrl: "/app/views/editor/code-editor.html",
        resolve: {
    ...
    $routeProvider.when("/workflow", {
        ...
        templateUrl: "/app/views/workflow/index.html"
    }).when('/workflow/new', {
        title: 'Workflow',
        templateUrl: '/app/views/workflow/edit.html',
        controller: 'workflowEditController'
    }).when("/workflow/:id", {
        title: 'Workflow',
        controller: "workflowShowController",
        templateUrl: "/app/views/workflow/show.html"
    });
    ...
    $routeProvider.when("/editor", {
        ...
        templateUrl: "/app/views/editor/index.html"
    });

    $routeProvider.when("/api", {
        title: 'API',
        controller: "apiController",
        templateUrl: "/app/views/api/index.html"
    }).when('/api/new', {
        title: 'API',
        templateUrl: '/app/views/api/edit.html',
        controller: 'apiEditController'
    }).when("/api/:id", {
        title: 'API',
        controller: "apiShowController",
        templateUrl: "/app/views/api/show.html"
    });
    ...
    $routeProvider.when("/scheduler", {
        ...
        templateUrl: "/app/views/scheduler/index.html"
    }).when('/scheduler/new', {
        title: 'Scheduler',
        ...
        title: 'Scheduler',
        controller: "schedulerShowController",
        templateUrl: "/app/views/scheduler/show.html"
    });
    ...
    $routeProvider.when("/conexoes", {
        ...
        templateUrl: "/app/views/conexoes/index.html"
    }).when('/conexoes/new', {
        title: 'Conexoes',
        templateUrl: '/app/views/conexoes/edit.html',
        controller: 'conexoesEditController'
    }).when("/conexoes/:id", {
        title: 'Conexoes',
        controller: "conexoesShowController",
        templateUrl: "/app/views/conexoes/show.html"
    });
    ...
    $routeProvider.when("/sistemas", {
        ...
        templateUrl: "/app/views/sistemas/index.html"
    }).when('/sistemas/new', {
        title: 'Sistemas',
        templateUrl: '/app/views/sistemas/edit.html',
        controller: 'sistemasEditController'
    }).when("/sistemas/:id", {
        title: 'Sistemas',
        controller: "sistemasShowController",
        templateUrl: "/app/views/sistemas/show.html"
    });
    ...
    $routeProvider.when("/usuario", {
        ...
        templateUrl: "/app/views/usuario/show.html"
    });
...
var serviceBase = 'http://191.238.247.35:8001/';
...
app.run(['authService', '$rootScope', '$route', function (authService, $rootScope, $route) {
    $rootScope.$on('$routeChangeSuccess', function (newVal, oldVal) {
        if (oldVal !== newVal) {
            $rootScope.title = $route.current.title;
            document.title = "Sennit Nimbus - " + $route.current.title;
        }
    });

    $rootScope.alertNotification = function(message, type){
        setTimeout(function () {
            $.growl('<span class="typcn typcn-weather-stormy typcn-th-large" style="color: white; font-size: 20px;"></span>  <strong>NIMBUS SENNIT INFORMA:</strong><hr style="padding:0px; margin-top:5px;margin-bottom:15px;"/>' +
                '<span style="margin-left:10px;margin-right:10px; margin-top:0px;">' + message + '<span/>', { type: type });
        }, 500);
    }

    $rootScope.ErroGet = "Ocorreu um erro ao tentar coletar os dados. Tente novamente mais tarde.";
    $rootScope.ErroPost = "Ocorreu um erro ao tentar gravar os dados. Tente novamente mais tarde.";
    $rootScope.ErroUpdate = "Ocorreu um erro ao tentar alterar os dados. Tente novamente mais tarde.";
    $rootScope.ErroUpdate = "Ocorreu um erro ao tentar deletar o registro. Tente novamente mais tarde.";
