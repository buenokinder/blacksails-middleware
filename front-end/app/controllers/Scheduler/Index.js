...
app.controller('schedulerController', ['$scope', 'schedulerService', 'authService', '$http', '$modal', '$log', function ($scope, schedulerService, authService, $http, $modal, $log) {
    ...
    $scope.items = [];
    $scope.itemsBase = [];
    $scope.serviceBase = "http://191.238.247.35:8001/";
    // Alert messages
    $scope.alerts = [{
        msg: "Welcome !"
    }];
