'use strict';
app.controller('sistemasShowController', ['$scope', 'sistemasService', 'authService', '$routeParams', 'conexoesService','$location', function ($scope, sistemasService, authService, $routeParams, conexoesService, $location) {
