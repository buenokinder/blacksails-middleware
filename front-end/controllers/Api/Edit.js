'use strict';
app.controller('apiEditController', ['$scope', 'apiService', 'sistemasService', 'authService', 'queriesService', function ($scope, apiService, sistemasService, authService, queriesService) {
